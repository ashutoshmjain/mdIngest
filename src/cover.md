...
- **Command:** `md-publish --text --number XXX`
- **Actions:** 
...
- **Command:** `md-publish --image --number XXX`
- **Actions:**
...
- **Command:** `md-publish --video --number XXX`
- **Actions:**
...
md-publish --text --number 240 --title "A Catchy Five Word Title"
md-publish --image --number 240
md-publish --video --number 240
```
